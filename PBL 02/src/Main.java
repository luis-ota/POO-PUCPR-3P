...
public class Main {
    public static void main(String[] args) {
        ...
        while (true){
            ...
            switch (indice) {
                ...
                case "4" -> Pontuacoes[jogador][nivel] = op4(Jogadores, jogador, Pontuacoes, nivel);
    ...
    static Object[] Menu(ArrayList<String> Jogadores,int jogador, int nivel, int[][] Pontuacoes) {
        System.out.println();
...
static void op3(ArrayList<String> Jogadores, int jogador, int[][] Pontuacoes) {
    ...
    for (int nivel = 0; nivel < Pontuacoes[jogador].length; nivel++) {
        ...
        System.out.printf("A pontuação do jogador %s no nivel %s foi: %s", Jogadores.get(jogador), nivel, Pontuacoes[jogador][nivel]);
    ...
    System.out.printf("Somando todos os niveis a pontuação total é de: %s", pontuacaoTotal);
    System.out.println();


}

static int op4(ArrayList<String> Jogadores, int jogador, int[][] Pontuacoes, int nivel) {
        System.out.println();

        System.out.printf("A pontuação do jogador %s no nivel %s é de: %s", Jogadores.get(jogador), nivel, Pontuacoes[jogador][nivel]);
        System.out.println();
...
static void op6(ArrayList<String> Jogadores, int[][] Pontuacao, int MaxJogadores, int MaxNiveis) {
        System.out.println();
